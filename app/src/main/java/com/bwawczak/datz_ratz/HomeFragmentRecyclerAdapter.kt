...
class HomeFragmentRecyclerAdapter(
    private var itemList: ArrayList<Snake>,
    ...
    fun setItemList(items: ArrayList<Snake>) {
        itemList = items
    }

    fun getItem(position: Int): Snake {
